...
def movie_info(movie, genres):
    ...
    genres_names['genre_names'] = movie['genre_names']
    genres_names['id'] = movie['id']
    genres_names['overview'] = movie['overview']
    genres_names['title'] = movie['title']
    genres_names['vote_average'] = movie['vote_average']
